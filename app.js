...
app.get("/profile/my/edit/:usrId", isLoggedIn, isOwner,wrapAsync(profile.showEditPage));
app.put("/profile/my/edit/:usrId", isLoggedIn, isOwner, upload.single("profile"), wrapAsync(profile.edit));
// -----------------------------------------------------------------------

// ----------------------------------show my profile---------------------------
app.get("/profile/my/:usrId", isLoggedIn, isOwner,wrapAsync(profile.my));
// ------------------------------------------------------------
